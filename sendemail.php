<?php
    ...
    $to         = 'prestige.ipc@gmail.com';

    $email_template = 'simple.html';

    $data = json_decode(file_get_contents("php://input"));

    $subject    = $data->subject;//strip_tags($_POST['subject']);
    $email       = $data->email;//strip_tags($_POST['email']);
    $phone      = $data->phone;//strip_tags($_POST['phone']);
    $name       = $data->name;//strip_tags($_POST['name']);
